  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      if ($_SESSION['nivel'] == 1 || $_SESSION['nivel'] == 100) {
        ...
        echo '<li class="dropdown"><a href="' . BASE_URL . 'Contrato/Revisar_Arrendamiento" class="nav-link"><i data-feather="file-text"></i><span>Arrendamiento</span></a></li>';
      ...
      // <!-- Administrables -->
      if ($_SESSION['nivel'] == 100 || $_SESSION['nivel'] == 100) {
        echo '<li class="dropdown">
