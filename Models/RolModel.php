...
class RolModel extends Query
{
    ...
    public function getRoles()
    {
        ...
        $sql = "SELECT 
                ...
                ORDER BY T.id asc ";
        // $sql = "SELECT T.id as tid,T.estado as testado from Roles as T ORDER BY id ASC";
    ...
    {
        $sql = "SELECT id,dni,apellido_nombre,direccion_id,regimen_id,horarioDetalle_id ,cargo_id,email,telefono,tarjeta,sexo, fecha_nacimiento,modalidad_trabajo,estado,nombre,apellido FROM Rol WHERE id = $id";
    ...
    {
        $sql = "SELECT id,dni FROM Rol WHERE dni = '$dni' ";
        return $this->select($sql);
    }
    ...
    {
        $sql = "INSERT INTO Rol (dni,nombre,apellido,direccion_id,regimen_id,horarioDetalle_id,cargo_id,email,telefono,tarjeta,sexo,fecha_nacimiento,modalidad_trabajo) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    {
        $sql = "UPDATE Rol SET dni=?,nombre=?,apellido=?,direccion_id=?,regimen_id=?,horarioDetalle_id=?,cargo_id=?,email=?,telefono=?,tarjeta=?,sexo=?,fecha_nacimiento=?,modalidad_trabajo=?,estado=? WHERE id = ?";
